...
const PROJECTS_DATA: Project[] = [
    ...
    { title: "SANSKAR (AR HERITAGE)", desc: "Built a mobile AR app for Android and iOS that recognizes physical museum exhibits and displays three-dimensional content with historical narratives when scanned.", video: "/videos/ar_heritage.mp4", color: "#00d4ff", id: "03", category: "Augmented Reality", link: "https://github.com/Avrsxvr/SanskAR" },
